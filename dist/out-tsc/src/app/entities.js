...
export class Zona1 {
    ...
    checkOra() {
        if (this.Ora.length != 5)
            return false;
        if (this.Ora.indexOf(":") == -1)
            return false;
...
export class Motor {
    ...
    hasError() {
        ...
        else if (this.Tip.toLowerCase() == 'altul' && CommonFunctions.isNullOrWhiteSpaces(this.TipAltul))
            toReturn.push("Tipul vehicului este obligatoriu!");
...
export class Zona12 {
    ...
    stabilireVinovatie() {
        ...
        if (this.Imprejurari.Imprejurari[0].VehiculA && !this.Imprejurari.Imprejurari[0].VehiculB)
            this.VinovatEstimat = "B";
        if (!this.Imprejurari.Imprejurari[0].VehiculA && this.Imprejurari.Imprejurari[0].VehiculB)
            this.VinovatEstimat = "A";
        //Daca am 2 la A si orice alta varianta la B este vinovat A/si invers
        if (!this.Imprejurari.Imprejurari[1].VehiculA && this.Imprejurari.Imprejurari[1].VehiculB)
            this.VinovatEstimat = "B";
        if (this.Imprejurari.Imprejurari[1].VehiculA && !this.Imprejurari.Imprejurari[1].VehiculB)
            this.VinovatEstimat = "A";
        //Daca am 3 la A si orice alta varianta la B este vinovat B/si invers
        if (this.Imprejurari.Imprejurari[2].VehiculA && !this.Imprejurari.Imprejurari[2].VehiculB)
            this.VinovatEstimat = "B";
        if (!this.Imprejurari.Imprejurari[2].VehiculA && this.Imprejurari.Imprejurari[2].VehiculB)
            this.VinovatEstimat = "A";
        //Daca am 4 la A si orice alta varianta la B este vinovat A/si invers
        if (!this.Imprejurari.Imprejurari[3].VehiculA && this.Imprejurari.Imprejurari[3].VehiculB)
            this.VinovatEstimat = "B";
        if (this.Imprejurari.Imprejurari[3].VehiculA && !this.Imprejurari.Imprejurari[3].VehiculB)
            this.VinovatEstimat = "A";
        //Daca am 5 la A si 8 la B este vinovat B/si invers
        if (this.Imprejurari.Imprejurari[4].VehiculA && this.Imprejurari.Imprejurari[7].VehiculB)
            this.VinovatEstimat = "B";
        if (this.Imprejurari.Imprejurari[4].VehiculB && this.Imprejurari.Imprejurari[7].VehiculA)
            this.VinovatEstimat = "A";
        //Daca am 6 la A si 7 la B este vinovat A/si invers
        if (this.Imprejurari.Imprejurari[5].VehiculA && this.Imprejurari.Imprejurari[6].VehiculB)
            this.VinovatEstimat = "A";
        if (this.Imprejurari.Imprejurari[5].VehiculB && this.Imprejurari.Imprejurari[6].VehiculA)
            this.VinovatEstimat = "B";
        //Daca am 9 la A si 10 la B este vinovat B/si invers
        if (this.Imprejurari.Imprejurari[8].VehiculA && this.Imprejurari.Imprejurari[9].VehiculB)
            this.VinovatEstimat = "B";
        if (this.Imprejurari.Imprejurari[8].VehiculB && this.Imprejurari.Imprejurari[9].VehiculA)
            this.VinovatEstimat = "A";
        //Daca am 11 la A si 12 sau 15 la B este vinovat B/si invers
        if (this.Imprejurari.Imprejurari[10].VehiculA && (this.Imprejurari.Imprejurari[11].VehiculB || this.Imprejurari.Imprejurari[14].VehiculB))
            this.VinovatEstimat = "B";
        if (this.Imprejurari.Imprejurari[10].VehiculB && (this.Imprejurari.Imprejurari[11].VehiculA || this.Imprejurari.Imprejurari[14].VehiculA))
            this.VinovatEstimat = "A";
        ...
        if (!this.Imprejurari.Imprejurari[15].VehiculA && this.Imprejurari.Imprejurari[15].VehiculB)
            this.VinovatEstimat = "B";
        if (this.Imprejurari.Imprejurari[15].VehiculA && !this.Imprejurari.Imprejurari[15].VehiculB)
            this.VinovatEstimat = "A";
        //Daca am 17 la A si orice la B este vinovat B.    
        if (!this.Imprejurari.Imprejurari[16].VehiculA && this.Imprejurari.Imprejurari[16].VehiculB)
            this.VinovatEstimat = "B";
        if (this.Imprejurari.Imprejurari[16].VehiculA && !this.Imprejurari.Imprejurari[16].VehiculB)
            this.VinovatEstimat = "A";
    }
